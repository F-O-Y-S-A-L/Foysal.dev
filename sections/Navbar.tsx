...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        className={`max-w-7xl mx-auto flex justify-between items-center transition-all duration-500 pointer-events-auto ${scrolled ? "bg-black/40 backdrop-blur-3xl rounded-3xl py-3 px-4 border border-white/15 w-[94%]" : "w-full px-6 xl:px-0"}`}
      >
        <motion.a
          href="#"
        ...
        >
          Foysal<span className="text-accent">.DEV</span>
        </motion.a>
